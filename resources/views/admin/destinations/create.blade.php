...
@section('title', 'إضافة وجهة جديدة | لوحة التحكم')
...
@section('content')
    ...
    <div class="page-header">
        <div>
            ...
            <p class="subtitle">أضف وجهة سياحية جديدة للمنصة</p>
        </div>
            ...
            <form action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex gap-3 justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-lg"></i> إضافة الوجهة
                    </button>
                </div>
            </form>
        </div>
...
<script>
    ...
    // تحميل الأقسام المخصصة المحفوظة مسبقاً (في حالة التعديل)
