...
@section('title', 'تعديل فندق | لوحة التحكم')
...
@section('content')
    <div class="breadcrumb-custom">
        ...
        <span>›</span>
        <span>تعديل فندق</span>
    </div>

    <div class="page-header">
        <div>
            <h1>تعديل فندق: {{ $hotel->name }} 🏨</h1>
            <p class="subtitle">تحديث معلومات الفندق</p>
        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                      id="description_ar" 
                                      name="description_ar" 
                                      rows="6">{{ old('description_ar', $hotel->description_ar) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                      id="description_en" 
                                      name="description_en" 
                                      rows="6">{{ old('description_en', $hotel->description_en) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   ...
                                   id="address_ar" 
                                   name="address_ar" 
                                   value="{{ old('address_ar', $hotel->address_ar) }}">
                            @error('address_ar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   ...
                                   id="address_en" 
                                   name="address_en" 
                                   value="{{ old('address_en', $hotel->address_en) }}">
                            @error('address_en')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                @php
                                    ...
                                    $hotelAmenities = old('amenities_ar', $hotel->amenities_ar ?? []);
                                @endphp
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" 
                                                   ...
                                                   name="amenities_ar[]" 
                                                   value="{{ $amenity }}"
                                                   {{ in_array($amenity, is_array($hotelAmenities) ? $hotelAmenities : []) ? 'checked' : '' }}>
                            ...
                            @if($hotel->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $hotel->image) }}" 
                                         alt="{{ $hotel->name }}" 
                                         style="width: 100%; border-radius: 12px; max-height: 200px; object-fit: cover; border: 2px solid #ddd;">
