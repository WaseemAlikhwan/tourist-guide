...
@section('title', 'تعديل نشاط | لوحة التحكم')
...
@section('content')
    ...
    <div class="page-header">
        <div>
            ...
            <p class="subtitle">تحديث تفاصيل النشاط السياحي</p>
        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('provider_id') is-invalid @enderror"
                                ...
                                @foreach($providers as $p)
                                    <option value="{{ $p->id }}" {{ old('provider_id', $activity->provider_id) == $p->id ? 'selected' : '' }}>
                                        {{ $p->name }} ({{ $p->email }})
                                    </option>
                                @endforeach
                            </select>
                            <div class="form-text">يُربط أرباح الحجوزات المدفوعة بهذا المزوّد.</div>
                            @error('provider_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('provider_review_status') is-invalid @enderror"
                                ...
                                <option value="approved" {{ old('provider_review_status', $activity->provider_review_status) === 'approved' ? 'selected' : '' }}>معتمد</option>
                                <option value="pending_review" {{ old('provider_review_status', $activity->provider_review_status) === 'pending_review' ? 'selected' : '' }}>قيد المراجعة</option>
                                <option value="rejected" {{ old('provider_review_status', $activity->provider_review_status) === 'rejected' ? 'selected' : '' }}>مرفوض</option>
                            </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text"
                                           ...
                                           id="type_ar"
                                           name="type_ar"
                                           value="{{ old('type_ar', $activity->type_ar) }}"
                                           required>
                                    @error('type_ar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text"
                                           ...
                                           id="location_ar"
                                           name="location_ar"
                                           value="{{ old('location_ar', $activity->location_ar) }}">
                                    @error('location_ar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description_ar') is-invalid @enderror"
                                      id="description_ar"
                                      name="description_ar"
                                      rows="6">{{ old('description_ar', $activity->description_ar) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description_en') is-invalid @enderror"
                                      id="description_en"
                                      name="description_en"
                                      rows="6">{{ old('description_en', $activity->description_en) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('highlights') is-invalid @enderror"
                                      ...
                                      name="highlights_ar"
                                      rows="4"
                                      placeholder="اكتب المعالم المميزة للنشاط، كل معلم في سطر جديد">{{ old('highlights_ar', $activity->highlights_ar) }}</textarea>
                            @error('highlights_ar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('highlights_en') is-invalid @enderror"
                                      ...
                                      name="highlights_en"
                                      rows="4"
                                      placeholder="Write highlights, one per line">{{ old('highlights_en', $activity->highlights_en) }}</textarea>
                            @error('highlights_en')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div id="bookingDetails" style="display: {{ old('requires_booking', $activity->requires_booking ?? true) ? 'block' : 'none' }};">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('whats_included') is-invalid @enderror"
                                          ...
                                          rows="4"
                                          placeholder="مثال: - النقل من وإلى الفندق&#10;- دليل سياحي محترف&#10;- وجبة غداء">{{ old('whats_included_ar', $activity->whats_included_ar) }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('whats_included_en') is-invalid @enderror"
                                          ...
                                          rows="4"
                                          placeholder="Example: - Hotel pickup and drop-off&#10;- Professional guide&#10;- Lunch meal">{{ old('whats_included_en', $activity->whats_included_en) }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('whats_not_included') is-invalid @enderror"
                                          ...
                                          rows="4"
                                          placeholder="مثال: - المشروبات&#10;- التذاكر الشخصية&#10;- النفقات الشخصية">{{ old('whats_not_included_ar', $activity->whats_not_included_ar) }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('whats_not_included_en') is-invalid @enderror"
                                          ...
                                          rows="4"
                                          placeholder="Example: - Drinks&#10;- Personal tickets&#10;- Personal expenses">{{ old('whats_not_included_en', $activity->whats_not_included_en) }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('additional_info') is-invalid @enderror"
                                          ...
                                          rows="4"
                                          placeholder="معلومات إضافية مهمة للزوار">{{ old('additional_info_ar', $activity->additional_info_ar) }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('additional_info_en') is-invalid @enderror"
                                          ...
                                          rows="4"
                                          placeholder="Important additional information for visitors">{{ old('additional_info_en', $activity->additional_info_en) }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('payment_policy') is-invalid @enderror"
                                          ...
                                          rows="4"
                                          placeholder="مثال: - الدفع نقداً عند الوصول&#10;- أو الدفع عبر البطاقة">{{ old('payment_policy_ar', $activity->payment_policy_ar) }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('payment_policy_en') is-invalid @enderror"
                                          ...
                                          rows="4"
                                          placeholder="Example: - Pay cash on arrival&#10;- Or pay by card">{{ old('payment_policy_en', $activity->payment_policy_en) }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('cancellation_policy') is-invalid @enderror"
                                          ...
                                          rows="4"
                                          placeholder="مثال: - يمكن الإلغاء مجاناً قبل 24 ساعة&#10;- بعد ذلك يتم خصم 50% من المبلغ">{{ old('cancellation_policy_ar', $activity->cancellation_policy_ar) }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('cancellation_policy_en') is-invalid @enderror"
                                          ...
                                          rows="4"
                                          placeholder="Example: - Free cancellation 24h before&#10;- Afterwards, 50% charge applies">{{ old('cancellation_policy_en', $activity->cancellation_policy_en) }}</textarea>
                        ...
                        <div class="card border-0 bg-light mb-4">
                            <div class="card-body">
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1" {{ old('is_featured', $activity->is_featured) ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" id="is_must_visit" name="is_must_visit" value="1" {{ old('is_must_visit', $activity->is_must_visit) ? 'checked' : '' }}>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @php
            $existingSectionsAr = old('custom_sections_ar', $activity->custom_sections_ar ?? []);
            $existingSectionsEn = old('custom_sections_en', $activity->custom_sections_en ?? []);
        ...
        // إذا كان هناك تاريخ محدد عند التحميل، اعرضه
        const eventDateInput = document.getElementById('event_date');
